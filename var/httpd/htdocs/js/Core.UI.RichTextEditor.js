...
// --
// $Id: Core.UI.RichTextEditor.js,v 1.20 2010/12/06 13:50:51 mn Exp $
// --
...
Core.UI.RichTextEditor = (function (TargetNS) {
    ...
    TargetNS.Init = function ($EditorArea) {
        ...
        Editor = CKEDITOR.replace(EditorID,
        {
            ...
            removePlugins : Core.Config.Get('RichText.RemovePlugins', 'elementspath,scayt,menubutton,contextmenu'),
            skin: 'default',
